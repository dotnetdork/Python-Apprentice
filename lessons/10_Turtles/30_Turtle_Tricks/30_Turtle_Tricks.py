...
import turtle                           # Tells Python we want to work with the turtle
turtle.setup(600,600,0,0)               # Set the size of the window
tina = turtle.Turtle()                  # Create a turtle named tina
tina.speed(0)                           # Set the speed of the turtle
...
tina.fillcolor("white")                 # Change the fill color
tina.begin_fill()                       # Start filling in the shape
tina.circle(50)                         # Draw a circle with a radius
tina.end_fill()                         # End filling in the shape

tina.penup()                            # Lift the pen to move without drawing
tina.goto(-100, 0)                      # Move to a new location
tina.pendown()                          # Put the pen down to start drawing
tina.fillcolor("black")                 # Change the fill color
tina.begin_fill()                       # Start filling in the shape
tina.circle(30)                         # Draw a circle with a radius
tina.end_fill()                         # End filling in the shape
